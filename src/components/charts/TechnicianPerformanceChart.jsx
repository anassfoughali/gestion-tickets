...
const TechnicianPerformanceChart = ({ data }) => {
  ...
  // ✅ Normaliser les champs — backend retourne "technicien" ou "name"
  ...
  console.log("📊 parTechnicien data:", normalized); // ✅ Debug
  ...
  return (
    <div className="p-5 bg-white border border-gray-100 shadow-sm rounded-xl">
      ...
      <p className="mb-4 text-xs text-gray-400">Tickets résolus vs ouverts</p>
      <ResponsiveContainer width="100%" height={220}>
        <BarChart data={normalized} layout="vertical">
          ...
          <Bar dataKey="ouverts" name="Ouverts" fill="#f59e0b" radius={[0, 4, 4, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
